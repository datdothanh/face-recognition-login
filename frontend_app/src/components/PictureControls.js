...
export const PictureControls = () => {
  ...
  const handleFileUpload = () => {
    ...
    if (input.files && input.files[0] && input.files[0].size < 5000000) {
      ...
      err[activeTab] = { screenshot: "The IMAGE file too large (max 5 MB)." };
      dispatch(setAuthError(err));
    } else {
      ...
      <div className="wrap-input100-image">
        <div className="form-check source-box">
          <ul className="source-nav">
            <li>
              <span
                className={
                  "nav-link " + (activeSource === "webcam" ? "active" : "")
                }
            ...
            <li>
              <span
                className={
                  "nav-link " + (activeSource === "file" ? "active" : "")
                }
            ...
            <li>
              <span
                className={
                  "nav-link " + (activeSource === "url" ? "active" : "")
                }
        ...
        {activeSource === "file" && (
          <>
            ...
            >
              {screenshot == null ? "Choose Photo" : "Choose New Photo"}
            </button>
            <input
              type="file"
              className="hidden"
